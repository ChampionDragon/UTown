 ...
 **/
public class ResnsiteActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.resnsite_meeting:
                SmallUtil.getActivity(ResnsiteActivity.this,ResnmeetingActivity.class);
                break;
        }
    }
}
