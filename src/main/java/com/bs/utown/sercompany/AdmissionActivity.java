 ...
 **/
public class AdmissionActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.admissioncomp_apply:
                SmallUtil.getActivity(AdmissionActivity.this, AdmissionApplyActivity.class);
                break;
            case R.id.admissioncomp_past:
                SmallUtil.getActivity(AdmissionActivity.this, UserApplyActivity.class);
                break;
        }
    }
}
