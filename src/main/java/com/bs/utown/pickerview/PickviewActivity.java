package com.bs.utown.pickerview;
...
import com.bs.utown.pickerview.other.DataModel;
import com.bs.utown.pickerview.other.ProvinceBean;
import com.bs.utown.pickerview.other.TypeBean;
...
/*++++++++++++++++++++++++++++++  ===============多项选择器======================  ++++++++++++++++++++++*/
    ...
    private void showOptions() {
        ...
        /*设置标题0-3个*/
        String[] labels = {"省"};
        new pickerViewUtil().optionPicker(this, "请选择城市", onOptionsSelectListener, options1Items, options2Items, options3Items, labels);
    }
